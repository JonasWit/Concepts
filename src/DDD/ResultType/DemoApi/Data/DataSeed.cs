...
public class DataSeed(ILogger<DataSeed> logger, BookstoreDbContext dbContext)
{
    ...
    public async Task SeedBooks()
    {
        ...
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Clean Code: A Handbook of Agile Software Craftsmanship", English).Value, English, new("9780132350884"), [RobertMartin], new Release(PrenticeHall, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2008, 08, 11)))), "clean-code"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Code Complete: A Practical Handbook of Software Construction", English).Value, English, new("9780735619678"), [SteveMcConnell], new Release(MicrosoftPress, new SeasonalEdition(YearSeason.Autumn, 2004), new Planned(new FullDate(new DateOnly(2004, 06, 09)))), "code-complete"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Code: The Hidden Language of Computer Hardware and Software", English).Value, English, new("9780735611313"), [CharlesPetzold], new Release(MicrosoftPress, new OrdinalEdition(1), new Published(new FullDate(new DateOnly(2000, 10, 21)))), "code"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Cracking the Coding Interview: 189 Programming Questions and Solutions", English).Value, English, new("9780984782857"), [GayleLaakmannMcDowell], new Release(CareerCup, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2015, 07, 01)))), "cracking-the-coding-interview"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Design Patterns: Elements of Reusable Object-Oriented Software", English).Value, English, new("9780201633610"), [ErichGamma, RichardHelm, RalphJohnson, JohnVlissides], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Published(new FullDate(new DateOnly(1994, 10, 21)))), "design-patterns"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Domain-Driven Design: Tackling Complexity in the Heart of Software", English).Value, English, new("9780321125217"), [EricEvans], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2003, 08, 30)))), "domain-driven-design"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Effective Java", English).Value, English, new("9780134685991"), [JoshuaBloch], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2008, 05, 08)))), "effective-java"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Object-Oriented Software Construction", English).Value, English, new("9780136291558"), [BertrandMeyer], new Release(PrenticeHall, new OrdinalEdition(1), new Published(new Year(1988))), "object-oriented-software-construction"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Patterns of Enterprise Application Architecture", English).Value, English, new("9780321127426"), [MartinFowler], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2002, 11, 15)))), "patterns-of-enterprise-application-architecture"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Programming Pearls", English).Value, English, new("9780201657883"), [JonBentley], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Published(new YearMonth(1999, 9))), "programming-pearls"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Refactoring: Improving the Design of Existing Code", English).Value, English, new("9780201485677"), [MartinFowler], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Published(new YearMonth(1999, 07))), "refactoring"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Test-Driven Development: By Example", English).Value, English, new("9780321146533"), [KentBeck], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2002, 11, 18)))), "test-driven-development"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("The Clean Architecture: A Craftsman's Guide to Software Structure and Design", English).Value, English, new("9780134494166"), [RobertMartin], new Release(PrenticeHall, new OrdinalEdition(1), new NotPlannedYet()), "the-clean-architecture"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("The Art of Computer Programming, Volumes 1-4A Boxed Set", English).Value, English, new("9780321751041"), [DonaldKnuth], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2011, 02, 14)))), "the-art-of-computer-programming"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("The C Programming Language", English).Value, English, new("9780131103627"), [BrianKernighan, DennisRitchie], new Release(PrenticeHall, new OrdinalEdition(1), new Published(new Year(1978))), "the-c-programming-language"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("The Mythical Man-Month: Essays on Software Engineering", English).Value, English, new("9780201835953"), [FrederickBrooks], new Release(AddisonWesleyProfessional, new OrdinalEdition(1), new Published(new Year(1975))), "the-mythical-man-month"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("The Pragmatic Programmer: From Journeyman to Master", English).Value, English, new("9780201616224"), [AndrewHunt, DavidThomas], new Release(AddisonWesleyProfessional, new SeasonalEdition(YearSeason.Summer, 1999), new Published(new YearMonth(1999, 10))), "the-pragmatic-programmer"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Working Effectively with Legacy Code", English).Value, English, new("9780131177055"), [MichaelFeathers], new Release(PrenticeHall, new OrdinalEdition(1), new Planned(new FullDate(new DateOnly(2004, 09, 10)))), "working-effectively-with-legacy-code"));
        await SeedBook(Book.CreateNew(BookTitle.TryCreate("Build a Large Language Model", English).Value, English, new("9781617296864"), [SebastianRaschka], new Release(Manning, new OrdinalEdition(1), new Published(new YearMonth(2024, 9))), "build-large-language-model"));
